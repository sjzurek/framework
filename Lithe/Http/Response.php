...
return new class($Settings, $Options) implements \Lithe\Contracts\Http\Response
{
     ...
     * @return \Lithe\Contracts\Http\Response Current Response object for chaining.
     */
     ...
     * @throws \Lithe\Contracts\Http\HttpException If the file is not found (404 Not Found).
     * @return void
     */
    public function download(string $file, ?string $name = null, array $headers = []): void
    {
        ...
        if (!file_exists($file)) {
            throw new \Lithe\Contracts\Http\HttpException(404, 'File not found');
        }
