...
class Line
{
    ...
    private static function loadDefaultCommands(): void
    {
        ...
        self::use([
            ...
            include __DIR__ . '/Commands/Modules/install.php',
            include __DIR__ . '/Commands/Modules/uninstall.php',
            include __DIR__ . '/Commands/Modules/update.php',
            include __DIR__ . '/Commands/Modules/version.php',
        ]);
    }
